...
| BehaviorSubject           | CurrentValueSubject + buffer             | This seems to be the type that holds @State under the hood. CurrentValueSubject behaves similarly to BehaviorSubject, but does not forward the current value to subscribers when it recieves a new subscription.                                                                                                      |
| Completable               | ❌                               |                                                                                                                                                                 |
| CompositeDisposable       | ❌                               |                                                                                                                                                                 |
